...
udResult vcInternalModels_Init()
{
  ...
  UD_ERROR_CHECK(vcMesh_Create(&gInternalMeshes[vcInternalMeshType_Cube], vcP3N3UV2VertexLayout, (int)udLengthOf(vcP3N3UV2VertexLayout), pCubeVertices, (uint32_t)udLengthOf(cubeVerticesFltArray), cubeIndices, (uint32_t)udLengthOf(cubeIndices)));
